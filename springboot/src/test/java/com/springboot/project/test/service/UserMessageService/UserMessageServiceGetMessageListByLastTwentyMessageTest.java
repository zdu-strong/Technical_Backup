...
public class UserMessageServiceGetMessageListByLastTwentyMessageTest extends BaseTest {
    private UserMessageModel userMessage;

    @Test
    public void test() throws URISyntaxException {
        var result = this.userMessageService.getMessageListByLastTwentyMessage(
